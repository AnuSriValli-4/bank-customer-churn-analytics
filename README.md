...
Data cleaning — dropped non-predictive identifier columns, encoded categorical features (Gender, Card Type)
EDA — correlation analysis, class distribution, outlier checks via boxplots, age distribution
Model selection — used LazyPredict to screen candidate models before deeper tuning
Modeling — tuned and evaluated three classifiers via grid search with cross-validation:
...
Evaluation - held out 15% of the data (stratified by class) to test final model performance


Results

ModelAccuracyAUCF1Random Forest85.3%82.4%52.5%AdaBoost83.1%82.5%49.3%KNN69.9%51.5%21.6%
